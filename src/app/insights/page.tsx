      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-10 md:py-14">
        ...
        <header className="pb-8 border-b border-white/[0.07]">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0 pt-1">
              ...
              <p className="mt-1 text-sm text-neutral-400">bibl.content.official@gmail.com</p>
            </div>
            {admin && (
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Link
                  href="/insights/admin"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white hover:bg-neutral-200 text-black text-sm font-bold transition"
                >
          ...
          <p className="mt-5 text-base md:text-lg text-neutral-300 leading-relaxed">
          ...
          <div className="mt-6 flex items-center gap-8">
            <div>
              <div className="text-xs text-neutral-500 mb-0.5">인사이트</div>
              <div className="text-xl font-bold text-white">{publishedCount}</div>
            </div>
            {totalViews > 0 && (
              <div>
                <div className="text-xs text-neutral-500 mb-0.5">총 조회수</div>
          ...
          {admin && (
            <Link
              href="/insights/admin"
              className="sm:hidden mt-5 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white hover:bg-neutral-200 text-black text-sm font-bold transition"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.4} strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></svg>
              새 글 작성
            </Link>
        ...
        <section className="mt-14">
          <div className="rounded-2xl bg-neutral-950 border border-neutral-800 p-6 md:p-8">
            <p className="text-sm font-semibold text-[#00E5A0] mb-2">유튜브 채널 대행</p>
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-5">
              ...
              기획·촬영·편집·업로드·운영까지 전 과정을 대행하는 <strong className="text-neutral-200">유튜브 채널 대행</strong> 서비스로
              시행착오 없이 채널을 성장시키세요.
            </p>
            <Link
              href="/studio"
              className="group inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-white hover:bg-neutral-200 text-black text-base font-bold transition"
            >
              올인원 유튜브 채널 대행 알아보기
